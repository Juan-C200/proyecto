<body class="pb-5" style="background-color:#f2f4f7;">
    
        <div class="container" id="container">
            
            <div class="row mt-2 mb-2 p-4">
                <h1 class="text mb-1 mt-2">Reportar</h1>
                <button class="categoriaR col-md-3 border rounded p-4 m-2 text-center btn btn-light" data-categoria="señal" data-formulario="formulario_señal">Señal en mal estado</button>
                <button class="categoriaR col-md-3 border rounded p-4 m-2 text-center btn btn-light" data-categoria="reductor" data-formulario="formulario_reductor">Reductor en mal estado</button>
                <button class="categoriaR col-md-3 border rounded p-4 m-2 text-center btn btn-light" data-categoria="via" data-formulario="formulario_via">Via en mal estado</button>
            </div>

            <div class="formulario d-none mb-5" id="formulario_señal">
                <form action="<?php echo getUrl("Reportes", "SeñalMalEstado", "postCreate");?>" method="POST" class="form-control p-4" id="" enctype="multipart/form-data" data-formulario="formulario_señal">
            ...
            <div class="formulario d-none" id="formulario_reductor">
                <form action="<?php echo getUrl("Reportes", "ReductorMalEstado", "postCreate");?>" method="POST" class="form-control p-4" id="" enctype="multipart/form-data" data-formulario="formulario_reductor">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <input type="hidden" name="tipo_reductor" id="reductor_seleccionado">
                    ...
                    <div class="mt-1">
                        ...
                        <div class="col-md-12 mt-3">
                            <h7 for="foto" class="form-label"><b>Adjuntar imagen del reductor en mal estado</b></h7><br>
                            <input type="file" class="mt-3" id="foto" name="foto" accept=".jpg,.jpeg,.png" 
                            value="<?php echo isset($_SESSION['values']['Adjuntar imagen del reductor en mal estado']) ? htmlspecialchars($_SESSION['values']['Adjuntar imagen del reductor en mal estado']) : ''; ?>" required>
                            <?php
                                if (isset($_SESSION['errores']['Adjuntar imagen del reductor en mal estado'])) {
                                    echo "<p class=' text-danger'>" . $_SESSION['errores']['Adjuntar imagen del reductor en mal estado'] . "</p>";
                                }
    ...
    <div class="formulario d-none mb-5" id="formulario_via">
                <form action="<?php echo getUrl("Reportes", "ViaMalEstado", "postCreate");?>" method="POST" class="form-control p-4" id="" enctype="multipart/form-data" data-formulario="formulario_via">
                ...
                <div class="row justify-content-center">  
                    ...
                    <div class="mt-1">
                        ...
                        <div class="col-md-12 mt-3">
                            <h7 for="foto" class="form-label"><b>Adjuntar imagen de la via en mal estado</b></h7><br>
                            <input type="file" class="mt-3" id="foto" name="foto" accept=".jpg,.jpeg,.png" 
                            value="<?php echo isset($_SESSION['values']['Adjuntar imagen de la señal en mal estado']) ? htmlspecialchars($_SESSION['values']['Adjuntar imagen de la via en mal estado']) : ''; ?>" required>
                            <?php
                                if (isset($_SESSION['errores']['Adjuntar imagen de la via en mal estado'])) {
                                    echo "<p class=' text-danger'>" . $_SESSION['errores']['Adjuntar imagen de la via en mal estado'] . "</p>";
                                }
