    ...
    <form action="<?php echo getUrl("Reportes", "ReductorMalEstado", "postCreate", false,"ajax");?>" method="POST" class="form-control p-4" enctype="multipart/form-data">
        ...
        <div class="row justify-content-center">
            ...
            <div class="row mt-2 justify-content-center">
                <button type="button" class="btn btn-primary col-md-3 border-1 rounded-1 tipo" data-panel="panel_reductor_mal_estado_modular" >Reductor modular</button>
                <button type="button" class="btn btn-ligth col-md-3 border-1 rounded-1 tipo" data-panel="panel_reductor_mal_estado_señalizacion" >Reductor de señalizacion</button>
                <button type="button" class="btn btn-ligth col-md-3 border-1 rounded-1 tipo" data-panel="panel_reductor_mal_estado_estructural" >Reductor estructural</button>
            </div>
            
            <div class="box p-3 border rounded-3">
                <div class=" p-1 col-md-12 panel" id="panel_reductor_mal_estado_modular">
                ...
                <div class="panel p-1 col-md-12 d-none" id="panel_reductor_mal_estado_señalizacion">
                ...
                <div class="panel p-1 col-md-12 d-none" id="panel_reductor_mal_estado_estructural">
