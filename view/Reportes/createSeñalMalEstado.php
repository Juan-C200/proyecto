    ...
    <form action="<?php echo getUrl("Reportes", "SeñalMalEstado", "postCreate", false,"ajax");?>" method="POST" class="form-control p-4 formularios" enctype="multipart/form-data">
        ...
        <div class="row justify-content-center">
            ...
            <div class="row mt-2 justify-content-center">
                <button type="button" class="btn btn-primary col-md-3 border-1 rounded-1 tipo" data-panel="panel_señal_mal_estado_vertical" >Señales Verticales</button>
                <button type="button" class="btn btn-ligth col-md-3 border-1 rounded-1 tipo" data-panel="panel_señal_mal_estado_horizontal" >Señales Horizontales</button>
            </div>
            
            <div class="box p-3 border rounded-3">
                <div class=" p-1 col-md-12 panel" id="panel_señal_mal_estado_vertical">
                ...
                <div class="panel p-1 col-md-12 d-none" id="panel_señal_mal_estado_horizontal">
                    <h5>
